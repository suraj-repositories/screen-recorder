	...
	public static void showSaveDialog(String filePath) {
		...
		if (result < 0) {
			...
			JOptionPane.showMessageDialog(null,
					"<html><b>Recording Saved!</b><br/>File: " + filePath + "<br/>Size: " + container.getFileSize()
							+ " bytes" + "<br/>Duration: " + container.getDuration() / 1_000_000 + " ms"
							+ "<br/>Bitrate: " + container.getBitRate() + "</html>",
					"Success", JOptionPane.INFORMATION_MESSAGE);
		}

		NotificationUtil.notify("Recording Complete", "Your recording has been saved successfully.");
	}
}
